            ...
            children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Expanded(
                                child: Image(
                              image: AssetImage(
                                  "assets/images/illustration-06.png"),
                            )),
                          ],
                        ),
                      ),
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context,
                          MaterialPageRoute(builder: (context) => javayt()));
                    },
                    child: Padding(
              ...
              Container(
                ...
                child: Text(
                  ...
                  " services designed for the future continue to rely on Java, as well.",
                  style: TextStyle(
                    fontSize: 20,
                  ),
                ),
              ...
              Container(
                ...
                child: Text(
                  ...
                  " which are not objects for performance reasons.",
              ...
              Container(
                margin: EdgeInsets.only(left: 10, bottom: 30),
                child: Text(
                  "All source files must be named after the public class they contain, "
              ...
              Container(
                margin: EdgeInsets.only(left: 10, bottom: 30),
                child: Text(
                  "The keyword public denotes that a method can be called from code "
                  ...
                  " the JVM will throw a SecurityException",
                  style: TextStyle(fontSize: 20),
                ),
              ),
          Padding(
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                    onPressed: () {
                      setState(() {
                        ...
                        recentlyAskedQuestions.add(question);
                ...
                ListView.builder(
                    shrinkWrap: true,
                    itemCount: recentlyAskedQuestions.length,
                    itemBuilder: (context, index) {
                      return ListTile(
                        title: Text(recentlyAskedQuestions[index]),
                      );
                    })
              ],
            ),
